    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <x-stat-card label="Payments This Month" :value="number_format($paymentsThisMonth, 2)" />
                <x-stat-card label="Expenses This Month" :value="number_format($expensesThisMonth, 2)" />
            </dl>
        </div>
    </div>
</x-app-layout>
